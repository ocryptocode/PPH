...
xls_file_path = r'C:\Users\PC\PycharmProjects\projetoussama\Base de données.xlsx'
...
class TextTransformer:
    ...
    def add_step(self, step_name, step_instance):
        self.steps.append((step_name, step_instance))
        return self
